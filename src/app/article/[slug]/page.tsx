...
import { ReadershipLine } from "@/components/engagement/ReadershipLine";
      ...
      <article>
        ...
        <div className="shell mt-12 md:mt-16">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-between gap-x-8 gap-y-5 border-t border-rule pt-6">
              <ShareButtons
                title={article.title}
